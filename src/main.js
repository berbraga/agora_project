...
let options =
{
    ...
    token: "007eJxTYFgau8RvLu/BnPJg2WzOxTNtFU2mW3Y28L6cPaV+/cXlsVYKDAaJ5gaGZkkpyWbJqSZJ5mYWJklpiRbGKcYGZiZJFkZG2nonkxsCGRmqlyswMTJAIIjPwlCQn2zCwAAAu18dEw==",
        ...
        if (document.getElementById('Audience').checked)
        {
            ...
            if(channelParameters.localAudioTrack != null && channelParameters.localVideoTrack != null)
            {
                ...
                if(channelParameters.remoteVideoTrack!=null)
                {
                    ...
                    // Play the remote svideo stream, if the remote user has joined the channel.
                    channelParameters.remoteVideoTrack.play(remotePlayerContainer);
                }
            }
